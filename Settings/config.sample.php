...
// - SERVER - //
DEFINE('API_DB_SERVER', 'localhost');
DEFINE('API_DB_NAME', 'wli_db');
DEFINE('API_DB_USER', 'wli_user');
DEFINE('API_DB_PASS', '');
...
// -- APP SETTINGS -- //
DEFINE('BASE_PATH', '/wli/api');
DEFINE('BASE_URL', 'http://wli.planet1107-solutions.net/api');
DEFINE('BASE_WEB_URL', 'http://wli.planet1107-solutions.net');
DEFINE('WEB_API_KEY', '@#WLi!RANDOM_GENERATED_KEY_TOKEN');
